...
#define BroadcastSendRtpStoppedArgs const std::string &vhost, const std::string &app, const std::string &stream, const std::string &ssrc, const toolkit::SockException &ex
